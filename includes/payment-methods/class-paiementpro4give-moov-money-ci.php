<?php
/**
 * PaiementPro for Give | Moov Money CI
 *
 * @since 1.0.0
 */
...
class PaiementPro4Give_Moov_Money_Ci {
	public function __construct() {
		add_action( 'give_gateway_paiementpro_moov_money_ci', [ $this, 'process_donation' ] );
		add_action( 'give_paiementpro_moov_money_ci_cc_form', '__return_false' );
	}
...
new PaiementPro4Give_Moov_Money_Ci();